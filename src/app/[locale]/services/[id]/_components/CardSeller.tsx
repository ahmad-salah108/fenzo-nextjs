...
async function CardSeller() {
  const t = await getTranslations();
  
  return (
    <div className="w-[298px] mx-auto bg-white rounded-[5px] overflow-hidden shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300">
